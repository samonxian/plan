/**
 * Dialog
 * http://www.caixw.com/public/uploads/demo/jquery/dialog/
...
function Dialog(content, options)
{
    ...
    /* 对话框的布局及标题内容。*/
    //console.log(options.contentTxt);
    var contentHtml = options.contentTxt;
    ...
    this.show = function()
    {
        ...
        /* 是否显示背景遮罩层 */
        if(options.modal)
        {   $('#' + overlayId).fadeTo('100', getOpacity(overlayId));   }
        dialog.fadeTo('50', getOpacity(options.id), function(){
