...
//        Yii::app()->clientScript->registerCssFile($publishedCss);
    ...
    public function getDayLink($day,$urlParams="") {
        return $this->getLink($this->year, $this->month, $day,$urlParams);
    }
    
    protected function getLink($year = null, $month = null, $day = null,$urlParams="") {
        $params = array();
        if(!is_null($year)) {
            $params['year'] = $year;
        }
        ...
        return Yii::app()->getController()->createUrl($urlParams, $params);
    }
