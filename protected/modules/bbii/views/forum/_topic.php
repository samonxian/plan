...
<div class="topic">
	...
	<div class="forum-cell main">
		...
		<?php if($this->isModerator()): ?>
			...
			<?php echo CHtml::image($this->module->getRegisteredImage('update.png'), 'update', array('title'=>Yii::t('BbiiModule.bbii', 'Update topic'), 'style'=>'cursor:pointer', 'onclick'=>'updateTopic(' . $data->id . ', "' . $this->createAbsoluteUrl('moderator/topic') . '")')); ?>
		<?php endif; ?>
		</div>
	</div>
