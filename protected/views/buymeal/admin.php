...
?>
<a class="<?php echo $active_[0];?>" href="<?php echo Yii::app()->createUrl('buymeal/admin');?>">开服套餐购买列表</a>
&nbsp;&nbsp;&nbsp;&nbsp;
<a class="<?php echo $active_[1];?>" href="<?php echo Yii::app()->createUrl('buymeal/gift');?>">礼包套餐购买列表</a>
<?php
...
//$labels = array_merge($labels,array("remaintime"));
