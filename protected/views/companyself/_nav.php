    ...
    <div>
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in">
                <a class="btn <?php echo $active[0]?>" href="<?php echo Yii::app()->createUrl('companyself/index');?>">公司信息</a>
                <a class="btn <?php echo $active[1]?>" href="<?php echo Yii::app()->createUrl('companyself/update',array('id'=>Yii::app()->session['id']));?>">完善公司信息</a>
            </div>
