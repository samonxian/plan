...
<!--        <div class="">
            <div class="control-group">
                ...
                <div style="margin:-20px 0 0 214px;">
                    <select id="pinfo_p_id" name="<?php echo ucfirst($this->id);?>[p_id]">
                        <option>请选择平台</option>
                    </select>
...
<?php    
    // Yii::app()->clientscript->registerScript('posiiton','
         // $("#Game_m_id").change(function (){
            // var text = $("#Game_m_id_chzn").find("a").find("span").text();
            // text = text.replace(/\s+/g,"");
            // if(text != "请选择厂商"){
                // $.post("'.Yii::app()->createUrl("game/create").'",{name:text},function (json){
