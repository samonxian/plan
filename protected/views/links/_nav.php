...
<div class="nav relative">
    <div>
        <ul class="nav nav-tabs">
            ...
            <li class="active">
                <a  href="<?php echo Yii::app()->createUrl('links');?>"> 友情链接</a>
            </li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane fade active in">
                <a class="btn <?php echo $active[0]?>" href="<?php echo Yii::app()->createUrl('links');?>">导入友情链接</a>
                <a class="btn <?php echo $active[1]?>" href="<?php echo Yii::app()->createUrl('links/admin');?>">友情链接列表</a>
            </div>
