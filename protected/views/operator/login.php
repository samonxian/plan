...
<head>
        ...
        <link href="<?php echo Yii::app()->baseUrl;?>/css/base.css" media="all" type="text/css" rel="stylesheet">
        <link href="<?php echo Yii::app()->baseUrl;?>/css/ie.css" media="all" type="text/css" rel="stylesheet">
