...
<!--                <a class="btn <?php echo $active[0]?>" href="<?php echo Yii::app()->createUrl('platform/create');?>">添加游戏平台</a>-->
                <a class="btn <?php echo $active[1]?>" href="<?php echo Yii::app()->createUrl('platform/uncheck');?>">未审核平台列表</a>
                <a class="btn <?php echo $active[2]?>" href="<?php echo Yii::app()->createUrl('platform/isrejected');?>">已拒绝平台列表</a>
                <a class="btn <?php echo $active[3]?>" href="<?php echo Yii::app()->createUrl('platform/ispassed');?>">已通过平台列表</a>
            </div>
