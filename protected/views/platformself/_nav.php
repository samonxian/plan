    ...
    <div>
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in">
                <a class="btn <?php echo $active[0]?>" href="<?php echo Yii::app()->createUrl('platformself/create');?>">添加游戏平台</a>
                <a class="btn <?php echo $active[1]?>" href="<?php echo Yii::app()->createUrl('platformself');?>">平台列表</a>
            </div>
