    ...
    <div>
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in">
                <a class="btn <?php echo $active[0]?>" href="<?php echo Yii::app()->createUrl('sservice/admin');?>">开服列表</a>
                <a class="btn <?php echo $active[1]?>" href="<?php echo Yii::app()->createUrl('company/ispassed');?>">添加开服</a>
                <a class="btn " href="<?php echo Yii::app()->createUrl('nominatemoney/create');?>">编辑推荐费用</a>
                <a class="btn " title="建议每周一点击清理" href="<?php echo Yii::app()->createUrl('sservice/re');?>">开服周排行清理</a>
            </div>
