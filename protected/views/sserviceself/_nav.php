    ...
    <div>
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in">
                <a class="btn <?php echo $active[0]?>" href="<?php echo Yii::app()->createUrl('sserviceself/admin');?>">开服列表</a>
                <a class="btn <?php echo $active[1]?>" href="<?php echo Yii::app()->createUrl('sserviceself/create');?>">我要开服</a>
                <a class="btn <?php echo $active[2]?>" href="<?php echo Yii::app()->createUrl('sserviceself/today');?>">今日开服</a>
